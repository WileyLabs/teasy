...
public interface ElementFactory {
    ...
    <T extends Element> T create(Class<T> classOfElement, TeasyWebElement wrappedElement);

    <T extends Element> T create(Class<T> classOfElement, TeasyWebElement wrappedElement, By by);
}
